    ...
    <div className="min-h-screen bg-slate-950 text-white flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-24 text-center">
        ...
        <p className="text-xl text-slate-400 mb-10 max-w-2xl">
          Rupalytic is the most intuitive expense tracker. Track spending, manage incomes, and conquer your financial goals in real-time.
        </p>
        
        <div className="flex flex-col sm:flex-row gap-4">
          <Link href="/signup">
            <Button size="lg" className="bg-emerald-500 hover:bg-emerald-600 text-white text-lg px-10 py-6 shadow-lg shadow-emerald-900/20">
              Create Free Account
            </Button>
          </Link>
        </div>
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl text-left">
          ...
          <Card className="bg-slate-900 border-slate-800">
            <CardHeader>
              <CardTitle className="text-white flex items-center gap-2">📊 Smart Analytics</CardTitle>
            </CardHeader>
            <CardContent className="text-slate-400">
          ...
          <Card className="bg-slate-900 border-slate-800">
            <CardHeader>
              <CardTitle className="text-white flex items-center gap-2">⚙️ Custom Settings</CardTitle>
            </CardHeader>
            <CardContent className="text-slate-400">
